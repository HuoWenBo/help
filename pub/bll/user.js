...
const user = {
  ...
  async updatePwd(ctx) {
    ...
    if (isNull.code == 1) {
      if (auth.code == 1) {
        form.oldPwd = com.secrets.decypt(
          form.oldPwd,
          "base64",
          com.ivkey,
          "hex",
        ...
        form.newPwd = com.secrets.decypt(
          form.newPwd,
          "base64",
          com.ivkey,
          "hex",
        ...
        form.confirmPwd = com.secrets.decypt(
          form.confirmPwd,
          "base64",
          com.ivkey,
          "hex",
   ...
   */
  async getList(ctx) {
    ctx.request.body.tables =
      "y_user left join area on y_user.a_id = area.pk_id ";
  ...
  async register(ctx) {
    ...
    // console.log(new Date(form.deadline).format('yyyy-MM-dd HH:mm:ss'))
    ...
    if (form.username == "" || form.username == undefined) {
      ...
      form.password = com.secrets.decypt(
        form.password,
        "base64",
        com.ivkey,
        "hex",
      ...
      form.checkPwd = com.secrets.decypt(
        form.checkPwd,
        "base64",
        com.ivkey,
        "hex",
        ...
        if (!uPattern.test(form.username)) {
          ...
          if (!pPattern.test(form.password)) {
            ...
            let res = await usermodel.addUser({
              ...
              a_id: form.a_id,
              phone: form.phone,
              deadline: new Date(form.deadline).format('yyyy-MM-dd HH:mm:ss'),
